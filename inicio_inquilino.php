...
<head>
  ...
  <style>
    ...
    gap: 20px;
    margin: 30px auto; /* Centra las tarjetas verticalmente */
    padding: 0 20px; /* Añade margen a ambos lados */
   ...
   <div class="container">
    ...
    <div class="cards">
        ...
        <div class="card">
            ...
            <button onclick="location.href='./matches/mostrar_matches.php'" class="card-button">Mis match</button>
            </div>
        </div>
        <div class="card">
            <div class="card-icon">🏠</div>
